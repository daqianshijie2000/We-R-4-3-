...
We will perform Chi_Squared test to check for any relation between the target variable(y) and the independent variables. 
...
* Chi-Squared test was performed to find any relation between the dependent variable(y) and the regressors. 
