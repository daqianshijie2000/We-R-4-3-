...
Model selection by exhaustive (default) search.
The plot will essentially show the Adjust R^2 when using the variables across the bottom
...
reg.best10 <- regsubsets(status~. , data = df2_bal, nvmax = 10, nbest = 1, method = "exhaustive")  # leaps::regsubsets() 
